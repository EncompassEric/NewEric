namespace Data.Seedwork
{
    ...
    public static class StringFieldNameSortingExtension
	{
		...
		public static IOrderedQueryable<TEntity> OrderUsingSortExpression<TEntity>(this IQueryable<TEntity> source, string sortExpression) where TEntity : class
		{
			...
			{
				throw new ArgumentException("Please assign sort expression.");
			}
			...
			for (int currentFieldIndex = 0; currentFieldIndex < orderFields.Length; currentFieldIndex++)
			{
				...
				Boolean sortDescending = (expressionPart.Length == 2) && (expressionPart[1].Equals("Descending", StringComparison.OrdinalIgnoreCase));
				if (sortDescending)
				{
