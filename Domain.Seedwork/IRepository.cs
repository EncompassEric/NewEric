namespace Domain.Seedwork
{
		...
		where TEntity : Entity
	{
		...
		/// <summary>
		/// Get paged elements of type TEntity that matching a Specification
		/// </summary>
		/// <typeparam name="KProperty">Sort property</typeparam>
		/// <param name="specification">Specification that result meet</param>
		...
		/// <returns>List of selected elements</returns>
		IEnumerable<TEntity> GetMatchingPaged(ISpecification<TEntity> specification, int pageIndex, int pageCount,
		...
		/// <param name="ascending">Specify if order is ascending</param>
		/// <returns>List of selected elements</returns>
		IEnumerable<TEntity> GetPaged<KProperty>(int pageIndex, int pageCount, Expression<Func<TEntity, KProperty>> orderByExpression, bool ascending,out int itemCount);
